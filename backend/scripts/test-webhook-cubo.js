...
if (failed > 0) {
  ...
  console.log(`
  Moneda confirmada: GTQ (quetzales) — cuenta Cubo configurada en Guatemala.
  Estas pruebas usan objetos simulados y no realizan cobros ni consultan producción.
  ...
  La activación y las migraciones de producción se validan por separado;
  este script no afirma ni modifica su estado.
  `);
}
